...
public class Lambda01 {
    ...
    static List<Integer> numbers=new ArrayList<>(Arrays.asList(5,65,-56,55,98,-89,65,55,21,54,9,35,35,34));
...
//        İşleme başlarken bir önceki değer olmadığı için bu değer identity parametresinde tanımlanmaktadır.
  ...
  public static void elemanlariCarp(List<Integer> sayilar){
    ...
    public static void teklerinKareBuyuktenKucuge(List<Integer> sayi) {
        sayi.stream()///liste akisaalindi/
                .filter(t->t%2==1)////tek olan rakamlari filtreledim
                .map(t->t*t)////het tek sayinin karesi alindi
                .sorted(Comparator.reverseOrder())//buyukten kucuge siralndi
                .forEach(Methodlarim::yazdir);
    }
    // Task : List elemanlarini alafabetik buyuk harf ve  tekrarsiz print ediniz.
    public static void alfabetikBuyukHarfTekrarsiz(List<String> yemek) {//yukarida tanimladigim listlerden calisacagim
    }
    ...
    public static void sonHarfeGoreTersSira(List<String> yemek) {
        yemek.stream().//akisa tabi
                sorted(Comparator//siralama aksiyonuna agirildi
                        .comparing(t->t.toString()//herbir eleman  stringe cevrildi elemanin kendisi alindi
                                .charAt(t.toString().length()-1)//son karakter char At ile alindi
    ...
    public static void karakterSayiYedidenBuyuk(List<String> yemek) {
        ...
        //modern yazim java 8
        System.out.println(yemek.stream()//kod akisa alindi
                .allMatch(t -> t.length() <= 7) ?//7 den kucuk olma durumu kontrol edildi ternary ile
    ...
    public static void karkterEnFazla(List<String> yemek) {
      ...
      Stream<String> sonIsim = //limit kullandigimiz icin bu sonucu sonIsim objesine atadik
              yemek.stream().sorted(Comparator.//sortladik
                      comparing(t->t.toString()).//sortlamayi lengt ye gore yaptik
        ...
        System.out.println(//son isim objesi data turu nedir stream old icin ben bunu arraya cevirmem gerekir
