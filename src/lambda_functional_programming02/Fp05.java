...
public class Fp05 {
    public static void main(String[] args) {
        ...
        System.out.println("ortalamaPuanlarVerilenSayidanBuyukMu " + ortalamaPuanlarVerilenSayidanBuyukMu(coursesList, 93));
        System.out.println("kelimeKursAdlariVarMi(coursesList" + kelimeKursAdlariVarMi(coursesList, "X"));
        ortalamasiEnYuksekKursunadiniYazdir(coursesList);//Turkish Night
        System.out.println();
...
////2)Kurs adlarından en az birinin verilen kelimeyi içerip içermediğini kontrol etmek için bir method oluşturun
    ...
    public static boolean kelimeKursAdlariVarMi(List<Courses> list, String kelime) {
        return list.stream().allMatch(t -> t.getCourseName().contains(kelime));
    }
